...
def render_footer():
    """Render the footer with developer info and social links"""
    st.markdown("---")
    st.markdown("""
        <div class="footer">
            <p class="footer-text">Developed by Rhitankar Bandyopadhyay</p>
    ...
    """.format(**SOCIAL_LINKS), unsafe_allow_html=True)
